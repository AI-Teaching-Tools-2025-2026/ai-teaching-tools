"""
Quiz Bank Pipeline — Configuration
===================================

Centralized configuration for the quiz generation pipeline.
...
# ---------------------------------------------------------------------------
TEXTBOOK_DIR: Path = Path("./textbook_chapters")  # directory containing .txt chapter files
...
COURSE_ID: str = "PSY_METHODS_01" # course identifier stored in every quiz doc
...
MONGO_DB_NAME: str = "quiz_bank"
MONGO_COLLECTION: str = "quizzes"

# ---------------------------------------------------------------------------
# Output / Logging
# ---------------------------------------------------------------------------
OUTPUT_DIR: Path = Path("./generated_quizzes")  # raw JSON outputs saved here
LOG_LEVEL: str = "INFO"
