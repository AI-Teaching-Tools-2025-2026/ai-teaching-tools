...
import { LayoutDashboard, NotebookTabs, FileQuestion, SquarePen, Database, ChevronLeft } from "lucide-react";
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "bg-neutral-800 text-neutral-50" : "hover:bg-neutral-800 text-neutral-400 hover:text-neutral-200",
                isCollapsed && "justify-center px-2"
              )}
            >
              <item.icon className={cn("h-5 w-5 shrink-0", isActive ? "text-neutral-50" : "text-neutral-400 group-hover:text-neutral-200")} />
              <span className={cn(
