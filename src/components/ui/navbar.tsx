...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50" style={{ background: "var(--800, #262626)" }}>
            ...
            <DropdownMenuTrigger asChild>
              <div className="cursor-pointer rounded-full hover:bg-neutral-500 p-1">
                <Avatar className="h-8 w-8">
                  <AvatarFallback className="bg-neutral-600 text-neutral-50">DT</AvatarFallback>
                </Avatar>
              </div>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-56 bg-neutral-800 border-neutral-600">
