...
export const questionBankService = {
    ...
    getQuestionBankById: async (questionBankId: string): Promise<QuestionBank> => {
        const response = await axios.get(
    ...
    createQuestionBank: async (questionBank: QuestionBank): Promise<QuestionBank> => {
    ...
    updateQuestionBank: async (questionBankId: string, questionBank: QuestionBank): Promise<QuestionBank> => {
    ...
    duplicateQuestionBankById: async (questionBankId: string): Promise<QuestionBank> => {
        const response = await axios.post(
